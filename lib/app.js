(function(){
    ...
    angular.module("app", ['greetings', 'greetingsOneWayBinding', 'votesTwoWayBinding', 'votesExpressionsBinding'])
        ...
        .controller("EntityNewController", function(){
            var that = this;
            ...
            //Le pasamos a Angular la ejecución de esta funcion como expresión.
            //Recogemos una de las claves del objeto que se usa para los atributos, en este caso llamado $event
            this.addEntity = function({entity}) {
                console.log("addEntity!!!!!!!!!!!!!");
                if (!entity) return;
                console.log(entity);
                //TODO: Esto sería una insercción en BBDD y si se inserta con éxito se notifica a user y si no también.
                that.parliament.entities.unshift(entity); //agrega al inicio del array
                //reseteamos el objeto newTodo para limpiar los inputs.
            }
