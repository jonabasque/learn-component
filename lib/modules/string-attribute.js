(function(){
    ...
    angular.module("greetings", [])
        ...
        // Aunque podriamos pasar un atributo one-way binding desde el padre, también el padre debería de estar watcheando la hora,
        // la decisión de que el propio componente genere el propio saludo es que no es que el contexto del componente es greetTime,
        //y tiene la posibilidad de saber por el mismo a que hora estamos y generar el saludo.
